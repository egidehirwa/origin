            ...
            <section className="px-10 py-10 relative bg-gradient-to-r from-[#7b8b7f] to-[#7b8b7f]" id="style">
                <div className="container mx-auto">
                    ...
                    <p className=" text-center font-secondaryFont text-base text-lightcream">
                        ...
                        make every effort to safeguard your information while also giving you control over it. This Privacy Policy is designed to provide you
                        with an understanding of the information we collect, the reasons behind it, and the ways in which you can manage, export, update, and
            ...
            <div className="px-5 py-24">
                <div className="xl:w-1/1.2 lg:w-3/4 w-full mx-auto ">
                    <p className="p-2 font-secondaryFont text-base text-lightcream ">
                        <ol className=" whitespace-pre-line list-decimal list-inside text-center leading-8 space-y-6	">
                            <p>
