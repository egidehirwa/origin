function ProfileIntroCard() {
  return (
    <div className="space-y-12 bg-lightcream p-8 rounded-lg relative overflow-hidden">
      ...
      />
      <div>
        <h1 className="text-black-900 text-xl font-bold">Charlotte Chocolat</h1>
      ...
      <div className="flex flex-row gap-6 justify-between px-4">
        <div className="text-center px-4 w-1/3 relative">
          ...
          <p className="text-black-200 text-[3rem]">28</p>
